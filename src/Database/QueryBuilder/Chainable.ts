...
export abstract class Chainable extends Macroable implements ChainableContract {
  ...
  public having (key: any, operator?: any, value?: any): this {
    if (value !== undefined) {
      ...
      this.knexQuery.having(this.resolveKey(key), operator, this.transformValue(operator))
    } else {
  ...
  public orHaving (key: any, operator?: any, value?: any): this {
    if (value !== undefined) {
      ...
      this.knexQuery.orHaving(this.resolveKey(key), operator, this.transformValue(operator))
    } else {
